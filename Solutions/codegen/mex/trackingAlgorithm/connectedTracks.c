                        ...
                        emxArray_int32_T *clustCols)
{
  ...
  for (track = 0; track < n; track++) {
    ...
    if (clustCols_data[track] == 0) {
      ...
      if (colStack->size[1] < 1) {
        emlrtDynamicBoundsCheckR2012b(1, 1, colStack->size[1], &cd_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      ...
      while (colStackSize > 0) {
        ...
        for (row = 0; row < nz; row++) {
          if (row + 1 > nz) {
            emlrtDynamicBoundsCheckR2012b(row + 1, 1, nz, &hd_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          if (currentCol > n) {
            emlrtDynamicBoundsCheckR2012b(currentCol, 1, n, &id_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          if (A_data[row + A->size[0] * (currentCol - 1)]) {
            vlen = clustRows_size[1];
            if (row + 1 > vlen) {
              emlrtDynamicBoundsCheckR2012b(row + 1, 1, vlen, &jd_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            if (clustRows_data[row] == 0) {
              ...
              for (k = 0; k < n; k++) {
                if (row + 1 > nz) {
                  emlrtDynamicBoundsCheckR2012b(row + 1, 1, nz, &ld_emlrtBCI,
                                                (emlrtConstCTX)sp);
                }
                if (k + 1 > n) {
                  emlrtDynamicBoundsCheckR2012b(k + 1, 1, n, &md_emlrtBCI,
                                                (emlrtConstCTX)sp);
                }
                  ...
                  if (clustCols_data[k] == 0) {
                    if (k + 1 > clustCols->size[1]) {
                      emlrtDynamicBoundsCheckR2012b(
                          k + 1, 1, clustCols->size[1], &od_emlrtBCI,
                          (emlrtConstCTX)sp);
                    }
                    ...
                    if (colStackSize > colStack->size[1]) {
                      emlrtDynamicBoundsCheckR2012b(
                          colStackSize, 1, colStack->size[1], &pd_emlrtBCI,
                          (emlrtConstCTX)sp);
                    }
  ...
  for (k = 0; k < currentCol; k++) {
    ...
    vlen = clustRows_size[1];
    if (i > vlen - 1) {
      emlrtDynamicBoundsCheckR2012b(i, 0, vlen - 1, &gd_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
