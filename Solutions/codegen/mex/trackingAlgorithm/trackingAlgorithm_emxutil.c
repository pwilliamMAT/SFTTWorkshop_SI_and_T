...
void c_emxCopyMatrix_fusion_tracker_(const c_fusion_tracker_targetspecs_Pa *src,
                                     c_fusion_tracker_targetspecs_Pa *dst)
{
  *dst = *src;
}
...
void c_emxCopyStruct_fusion_tracker_(const emlrtStack *sp,
                                     ...
                                     const emlrtRTEInfo *srcLocation)
{
  c_fusion_tracker_sensorspecs_Ae r1;
  c_fusion_tracker_targetspecs_Pa r;
  c_emxCopyMatrix_fusion_tracker_(&src->TargetSpecifications[0], &r);
  dst->TargetSpecifications[0] = r;
  d_emxCopyMatrix_fusion_tracker_(&src->SensorSpecifications[0], &r1);
  dst->SensorSpecifications[0] = r1;
...
void d_emxCopyMatrix_fusion_tracker_(const c_fusion_tracker_sensorspecs_Ae *src,
...
void emxEnsureCapacity_cell_wrap_74(const emlrtStack *sp,
                                    emxArray_cell_wrap_74 *emxArray,
                                    int32_T oldNumel,
                                    const emlrtRTEInfo *srcLocation)
{
  int32_T i;
  ...
  if (newNumel > emxArray->allocatedSize) {
    ...
    newData = emlrtMallocMex((uint32_T)newCapacity * sizeof(cell_wrap_74));
    if (newData == NULL) {
      emlrtHeapAllocationErrorR2012b(srcLocation, (emlrtCTX)sp);
    }
    if (emxArray->data != NULL) {
      memcpy(newData, emxArray->data,
             sizeof(cell_wrap_74) * (uint32_T)oldNumel);
      if (emxArray->canFreeData) {
        emlrtFreeMex(emxArray->data);
      }
    }
    emxArray->data = (cell_wrap_74 *)newData;
    emxArray->allocatedSize = newCapacity;
    emxArray->canFreeData = true;
  }
  if (oldNumel > newNumel) {
    emxExpand_cell_wrap_74(emxArray, oldNumel, newNumel);
  }
}

void emxEnsureCapacity_cell_wrap_75(const emlrtStack *sp,
                                    emxArray_cell_wrap_75 *emxArray,
                                    int32_T oldNumel,
                                    const emlrtRTEInfo *srcLocation)
{
  int32_T i;
  ...
  if (newNumel > emxArray->allocatedSize) {
    ...
    newData = emlrtCallocMex((uint32_T)newCapacity, sizeof(cell_wrap_75));
    if (newData == NULL) {
      emlrtHeapAllocationErrorR2012b(srcLocation, (emlrtCTX)sp);
    }
    if (emxArray->data != NULL) {
      memcpy(newData, emxArray->data,
             sizeof(cell_wrap_75) * (uint32_T)oldNumel);
      if (emxArray->canFreeData) {
        emlrtFreeMex(emxArray->data);
      }
    }
    emxArray->data = (cell_wrap_75 *)newData;
    emxArray->allocatedSize = newCapacity;
    emxArray->canFreeData = true;
  }
  if (oldNumel > newNumel) {
    emxTrim_cell_wrap_75(sp, emxArray, newNumel, oldNumel);
  } else if (oldNumel < newNumel) {
    emxExpand_cell_wrap_75(sp, emxArray, oldNumel, newNumel, srcLocation);
  }
}
...
void emxExpand_cell_wrap_74(emxArray_cell_wrap_74 *emxArray, int32_T fromIndex,
                            int32_T toIndex)
{
  int32_T i;
  for (i = fromIndex; i < toIndex; i++) {
    emxInitStruct_cell_wrap_74(&emxArray->data[i]);
  }
}

void emxExpand_cell_wrap_75(const emlrtStack *sp,
                            emxArray_cell_wrap_75 *emxArray, int32_T fromIndex,
                            int32_T toIndex, const emlrtRTEInfo *srcLocation)
{
  int32_T i;
  for (i = fromIndex; i < toIndex; i++) {
    emxInitStruct_cell_wrap_75(sp, &emxArray->data[i], srcLocation);
  }
}
...
void emxFreeStruct_cell_wrap_75(const emlrtStack *sp, cell_wrap_75 *pStruct)
{
...
void emxFree_cell_wrap_74(const emlrtStack *sp,
                          emxArray_cell_wrap_74 **pEmxArray)
{
  if (*pEmxArray != (emxArray_cell_wrap_74 *)NULL) {
    if (((*pEmxArray)->data != (cell_wrap_74 *)NULL) &&
        (*pEmxArray)->canFreeData) {
      emlrtFreeMex((*pEmxArray)->data);
    }
    emlrtFreeMex((*pEmxArray)->size);
    emlrtRemoveHeapReference((emlrtCTX)sp, (void *)pEmxArray);
    emlrtFreeEmxArray(*pEmxArray);
    *pEmxArray = (emxArray_cell_wrap_74 *)NULL;
  }
}

void emxFree_cell_wrap_75(const emlrtStack *sp,
                          emxArray_cell_wrap_75 **pEmxArray)
{
  int32_T i;
  if (*pEmxArray != (emxArray_cell_wrap_75 *)NULL) {
    if ((*pEmxArray)->data != (cell_wrap_75 *)NULL) {
      int32_T numEl;
      numEl = 1;
      for (i = 0; i < (*pEmxArray)->numDimensions; i++) {
        numEl *= (*pEmxArray)->size[i];
      ...
      for (i = 0; i < numEl; i++) {
        emxFreeStruct_cell_wrap_75(sp, &(*pEmxArray)->data[i]);
      }
      if ((*pEmxArray)->canFreeData) {
        emlrtFreeMex((*pEmxArray)->data);
      }
    ...
    emlrtRemoveHeapReference((emlrtCTX)sp, (void *)pEmxArray);
    emlrtFreeEmxArray(*pEmxArray);
    *pEmxArray = (emxArray_cell_wrap_75 *)NULL;
  }
}
...
void emxInitStruct_cell_wrap_74(cell_wrap_74 *pStruct)
{
  pStruct->f1.size[0] = 0;
  pStruct->f1.size[1] = 0;
}

void emxInitStruct_cell_wrap_75(const emlrtStack *sp, cell_wrap_75 *pStruct,
                                const emlrtRTEInfo *srcLocation)
{
...
void emxInit_cell_wrap_74(const emlrtStack *sp,
                          emxArray_cell_wrap_74 **pEmxArray,
                          const emlrtRTEInfo *srcLocation)
{
  emxArray_cell_wrap_74 *emxArray;
  *pEmxArray = (emxArray_cell_wrap_74 *)emlrtMallocEmxArray(
      sizeof(emxArray_cell_wrap_74));
  if ((void *)*pEmxArray == NULL) {
    emlrtHeapAllocationErrorR2012b(srcLocation, (emlrtCTX)sp);
  }
  emlrtPushHeapReferenceStackEmxArray((emlrtCTX)sp, true, (void *)pEmxArray,
                                      (void *)&emxFree_cell_wrap_74, NULL, NULL,
                                      NULL);
  emxArray = *pEmxArray;
  emxArray->data = (cell_wrap_74 *)NULL;
  emxArray->numDimensions = 1;
  emxArray->size = (int32_T *)emlrtMallocMex(sizeof(int32_T));
  if ((void *)emxArray->size == NULL) {
    emlrtHeapAllocationErrorR2012b(srcLocation, (emlrtCTX)sp);
...
void emxInit_cell_wrap_75(const emlrtStack *sp,
                          emxArray_cell_wrap_75 **pEmxArray,
                          const emlrtRTEInfo *srcLocation)
{
  emxArray_cell_wrap_75 *emxArray;
  *pEmxArray = (emxArray_cell_wrap_75 *)emlrtMallocEmxArray(
      sizeof(emxArray_cell_wrap_75));
  if ((void *)*pEmxArray == NULL) {
    emlrtHeapAllocationErrorR2012b(srcLocation, (emlrtCTX)sp);
  }
  emlrtPushHeapReferenceStackEmxArray((emlrtCTX)sp, true, (void *)pEmxArray,
                                      (void *)&emxFree_cell_wrap_75, NULL, NULL,
                                      NULL);
  emxArray = *pEmxArray;
  emxArray->data = (cell_wrap_75 *)NULL;
  emxArray->numDimensions = 1;
  emxArray->size = (int32_T *)emlrtMallocMex(sizeof(int32_T));
  if ((void *)emxArray->size == NULL) {
    emlrtHeapAllocationErrorR2012b(srcLocation, (emlrtCTX)sp);
...
void emxTrim_cell_wrap_75(const emlrtStack *sp, emxArray_cell_wrap_75 *emxArray,
                          int32_T fromIndex, int32_T toIndex)
{
  int32_T i;
  for (i = fromIndex; i < toIndex; i++) {
    emxFreeStruct_cell_wrap_75(sp, &emxArray->data[i]);
  }
}
