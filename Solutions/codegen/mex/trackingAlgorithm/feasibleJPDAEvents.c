                        ...
                        emxArray_boolean_T *outFJE)
{
  ...
  emxEnsureCapacity_boolean_T(&b_st, omega, ibtile, &ei_emlrtRTEI);
  ...
  emxInit_uint32_T(sp, &Xjs, 2, &fi_emlrtRTEI, true);
  ibtile = Xjs->size[0] * Xjs->size[1];
  Xjs->size[0] = validationMatrix->size[0];
  Xjs->size[1] = validationMatrix->size[1];
  emxEnsureCapacity_uint32_T(sp, Xjs, ibtile, &fi_emlrtRTEI);
  Xjs_data = Xjs->data;
  ...
  for (k = 0; k < numMeas; k++) {
    ...
    b_ii->size[0] = 1;
    emxEnsureCapacity_int32_T(sp, b_ii, ibtile, &ii_emlrtRTEI);
    ii_data = b_ii->data;
    ...
    for (jcol = 0; jcol <= numTrks; jcol++) {
      ...
      if (ii->size[1] == 0) {
        if (k + 1 > Xjs->size[0]) {
          emlrtDynamicBoundsCheckR2012b(k + 1, 1, Xjs->size[0], &qg_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        if (jcol + 1 > Xjs->size[1]) {
          emlrtDynamicBoundsCheckR2012b(jcol + 1, 1, Xjs->size[1], &rg_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        Xjs_data[k + Xjs->size[0] * jcol] = 0U;
      } else {
        if ((b_ii_data[0] < 1) || (b_ii_data[0] > iacol)) {
          emlrtDynamicBoundsCheckR2012b(b_ii_data[0], 1, iacol, &ng_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        if (k + 1 > Xjs->size[0]) {
          emlrtDynamicBoundsCheckR2012b(k + 1, 1, Xjs->size[0], &og_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        if (jcol + 1 > Xjs->size[1]) {
          emlrtDynamicBoundsCheckR2012b(jcol + 1, 1, Xjs->size[1], &pg_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
  ...
  while (j <= (uint32_T)numMeas) {
    ...
    while ((L < (uint32_T)(X_tmp - 1)) && (j <= (uint32_T)numMeas)) {
      ...
      if ((j < 1U) || ((int32_T)j > Xjs->size[0])) {
        emlrtDynamicBoundsCheckR2012b((int32_T)j, 1, Xjs->size[0], &bg_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      qY = Xj + 1U;
      if (Xj + 1U < Xj) {
      ...
      if (Xj == 0U) {
        ...
        if (!any(&st, &c_X_data)) {
          ...
          if (b) {
            emlrtDynamicBoundsCheckR2012b((int32_T)L, 1, X_tmp, &gg_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
  ...
  if (nPotentials < 1) {
    ...
    if (FJE->size[2] < 1) {
      emlrtDynamicBoundsCheckR2012b(1, 1, FJE->size[2], &yf_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    if (nPotentials > FJE->size[2]) {
      emlrtDynamicBoundsCheckR2012b(nPotentials, 1, FJE->size[2], &xf_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
  }
  iacol = FJE->size[0];
  ...
  emxEnsureCapacity_boolean_T(sp, outFJE, ibtile, &hi_emlrtRTEI);
