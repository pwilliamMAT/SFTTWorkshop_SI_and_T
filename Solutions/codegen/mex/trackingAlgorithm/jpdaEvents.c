...
static emlrtRSInfo ccb_emlrtRSI = {
    ...
    "jpdaEvents", /* fcnName */
    "C:\\Program "
    "Files\\MATLAB\\R2025b\\toolbox\\fusion\\core\\fusion\\jpdaEvents.m" /* pathName
                                                                          */
};
...
static emlrtRSInfo dcb_emlrtRSI = {
    ...
    "internal\\+assignment\\kbestJPDAEvents.m" /* pathName */
};
...
static emlrtRSInfo vib_emlrtRSI = {
    ...
    "C:\\Program "
    "Files\\MATLAB\\R2025b\\toolbox\\fusion\\core\\fusion\\+fusion\\+"
    "internal\\+assignment\\feasibleAndSortKBestEvents.m" /* pathName */
};
...
static emlrtRSInfo mjb_emlrtRSI = {
    ...
    "C:\\Program "
    "Files\\MATLAB\\R2025b\\toolbox\\fusion\\core\\fusion\\+fusion\\+"
    "internal\\+assignment\\jointFeasibleEventLikelihood."
    "m" /* pathName */
};
...
static emlrtRTEInfo fb_emlrtRTEI = {
    ...
    "C:\\Program "
    "Files\\MATLAB\\R2025b\\toolbox\\fusion\\core\\fusion\\+fusion\\+"
    "internal\\+assignment\\kbestJPDAEvents.m" /* pName */
};
...
static emlrtBCInfo sd_emlrtBCI = {
    ...
    "C:\\Program "
    "Files\\MATLAB\\R2025b\\toolbox\\fusion\\core\\fusion\\+fusion\\+"
    "internal\\+assignment\\feasibleAndSortKBestEvents.m", /* pName */
    0                                                      /* checkKind */
};
                ...
                emxArray_real_T *varargout_2)
{
  ...
  if (varargin_1->size[0] <= 1) {
    emlrtErrorWithMessageIdR2018a(
        &st, &jb_emlrtRTEI, "fusion:jpdaEvents:expectedLikelihoodMoreRows",
        "fusion:jpdaEvents:expectedLikelihoodMoreRows", 0);
  }
  if (varargin_1->size[1] <= 1) {
    emlrtErrorWithMessageIdR2018a(
        &st, &ib_emlrtRTEI, "fusion:jpdaEvents:expectedLikelihoodMoreColumns",
...
#pragma omp parallel for num_threads(jpdaEvents_numThreads)
  ...
  if (!all(&b_st, isTrackUnassigned)) {
    emlrtErrorWithMessageIdR2018a(
        &st, &fb_emlrtRTEI, "fusion:jpdaEvents:expectedNonzeroLikelihoodColumn",
  ...
  if (guard1) {
    ...
    if (b_p) {
      emlrtErrorWithMessageIdR2018a(
          &d_st, &x_emlrtRTEI, "Coder:toolbox:ElFunDomainError",
          "Coder:toolbox:ElFunDomainError", 3, 4, 3, "log");
    }
    e_st.site = &wdb_emlrtRSI;
    f_st.site = &xr_emlrtRSI;
    if (nx > 2147483646) {
...
#pragma omp parallel for num_threads(jpdaEvents_numThreads)
    ...
    for (b_i = 0; b_i < loop_ub; b_i++) {
      if (b_i + 1 > loop_ub) {
        emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, loop_ub, &wd_emlrtBCI, &c_st);
      }
      d_st.site = &njb_emlrtRSI;
      ...
      e_st.site = &jjb_emlrtRSI;
      f_st.site = &mp_emlrtRSI;
      if ((allFJE->size[1] != isTrackUnassigned->size[1]) &&
          (allFJE->size[1] != 0)) {
        emlrtErrorWithMessageIdR2018a(
            &f_st, &l_emlrtRTEI, "MATLAB:catenate:matrixDimensionMismatch",
    ...
    if (kFound < 1) {
      ...
      if (logposterior->size[0] < 1) {
        emlrtDynamicBoundsCheckR2012b(1, 1, logposterior->size[0], &sd_emlrtBCI,
                                      &b_st);
      }
    ...
    c_st.site = &ajb_emlrtRSI;
    d_st.site = &ajb_emlrtRSI;
    d = logsumexp(&d_st, logkposterior);
...
#pragma omp parallel for num_threads(jpdaEvents_numThreads)
    ...
    if (kFound < 1) {
      ...
      if (b_loop_ub < 1) {
        emlrtDynamicBoundsCheckR2012b(1, 1, b_loop_ub, &ud_emlrtBCI, &b_st);
      }
      if (kFound > b_loop_ub) {
        emlrtDynamicBoundsCheckR2012b(kFound, 1, b_loop_ub, &vd_emlrtBCI,
                                      &b_st);
      }
    }
    sizes[0] = 1;
      ...
      for (b_i = 0; b_i < z; b_i++) {
        for (i4 = 0; i4 < c_loop_ub; i4++) {
          ...
          if ((nPotentials < 1) || (nPotentials > loop_ub)) {
            emlrtDynamicBoundsCheckR2012b(nPotentials, 1, loop_ub, &xd_emlrtBCI,
                                          &b_st);
          }
