...
disp(passengerSpec) %[output:11d96796]
...
trackerUpdateInterval = 1; % seconds %[control:slider:6ef2]{"position":[25,26]}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
doc trackOSPAMetric % Opens documentation page for trackOSPAMetric
% WRITE YOUR CODE BELOW THIS LINE:
