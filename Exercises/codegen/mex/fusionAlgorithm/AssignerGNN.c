...
static emlrtRSInfo mm_emlrtRSI = {
    ...
    "+internal/+fusion/AssignerGNN.m" /* pathName */
};
...
static emlrtRSInfo jo_emlrtRSI = {
    ...
    "/MATLAB/toolbox/eml/eml/+coder/+internal/reduceToScalar.m" /* pathName */
};
...
static emlrtRTEInfo be_emlrtRTEI = {
    ...
    "/MATLAB/toolbox/eml/lib/matlab/ops/eml_mtimes_helper.m" /* pName */
};
...
static emlrtRTEInfo ee_emlrtRTEI = {
    ...
    "AssignerGNN", /* fName */
    "/MATLAB/toolbox/shared/tracking/fusionlib/+matlabshared/+tracking/"
    "+internal/+fusion/AssignerGNN.m" /* pName */
};
                          ...
                          emxArray_uint32_T *unassignedColumns)
{
  ...
  if ((colToRow->size[0] == 0) && (nOut > 0)) {
    ...
    f_st.site = &jo_emlrtRSI;
    maxVal = 0.0;
    g_st.site = &ko_emlrtRSI;
